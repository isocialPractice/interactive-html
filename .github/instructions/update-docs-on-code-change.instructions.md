...
- **apply-doc-verification** : false
  - **apply-condition** : unset
- **apply-doc-quality-standard** : false
  - **apply-condition** : unset
- **apply-automation-tooling** : false
  - **apply-condition** : unset
- **apply-doc-patterns** : true
  - **apply-condition** : unset
- **apply-best-practices** : true
  - **apply-condition** : unset
- **apply-validation-commands** : false
  - **apply-condition** : unset
- **apply-maintenance-schedule** : false
  - **apply-condition** : unset
